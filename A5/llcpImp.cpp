...
void RemBadSplitGood(Node* list1, Node* list2, Node* list3)
{
   if (list1->link == 0)
   {
...
/*   
   do
   {
      ...
      if (list1->data >= 0 && list1->data <= 5)
      {
         Node *temp2;
         temp2->data = list1->data;
         temp2->link = list1->link;
      }
      if (list1->data >= 7 && list1->data <= 9)
      {
         Node *temp3;
         temp3->data = list1->data;
         temp3->link = list1->link;
