...
#include "sequence.h"
namespace seqT  = CS3358_SP16_A04_sequenceOfNum;
using namespace std;
...
{
   seqT::sequence<double> s1;  // A sequence of double for testing
   seqT::sequence<char> s2; // A sequence of char for testing
